...
<head>
    ...
    <style>
        ...
        .container {
            ...
            text-align: center;
            max-width: 100%;
            width: 400px; /* Ограничение ширины для мобильных устройств */
        }
        h1 {
            font-size: 1.5rem;
            margin-bottom: 20px;
        ...
        .g-recaptcha {
            margin-bottom: 15px; /* Убираем лишние отступы */
        }
        /* Для маленьких экранов увеличиваем размер шрифта и подгоняем кнопку */
